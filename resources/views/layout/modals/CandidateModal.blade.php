    ...
    <div class="modal-dialog modal-dialog-right modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title h4">modal name</h5>
                    ...
                    <div class="col-md-8">
                        <form id="candidateForm">
                            ...
                            <div class="form-row col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="candidateLinkedIn" class="control-label">linkedIn <a class="showLink" target="_blank" ><i class="fal fa-link"></i> </a></label>
                                ...
                                <div class="col-md-12 row">
                                    ...
                                    <div class="form-group col-md-7" id="documentsDiv">
                                        <label for="candidateUploadedDocuments" class="control-label">ატვირთული დოკუმენტები</label>
