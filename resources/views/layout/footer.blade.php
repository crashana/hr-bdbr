...
<footer class="page-footer" role="contentinfo">
    <div class="d-flex align-items-center flex-1 text-muted">
        <span class="hidden-md-down fw-700">{{date('Y')}} ©  &nbsp;<a href='{{url('/')}}' class='text-primary fw-500' title=''   target='_blank'>{{config('env.app_name')}}</a></span>
    </div>
    <div>
                                ...
                                <div id="skin-default" data-action="toggle-replace"
                                    ...
                                    <div class="d-flex flex-column flex-1">
                                        ...
                                        <div class="bg-faded flex-1 pt-3 pb-3 px-2">
                                            <div class="py-3"
                                                 style="background:url('{{asset('assets/img/s-1.png')}}') top left no-repeat;background-size: 100%;"></div>
                                        </div>
                                    </div>
                                </div>
                                Default
